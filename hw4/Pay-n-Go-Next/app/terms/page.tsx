    ...
    <div className="container mx-auto px-4 py-8">
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground">Last updated: December 7, 2023</p>
        </CardHeader>
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pay-n-Go.
            </li>
            <li>
            ...
            <li><strong>Website</strong> refers to Pay-n-Go, accessible from arneseconte.it</li>
            <li>
          ...
          <p>
            ...
            included thereon; (ii) that the Service will be uninterrupted or error-free; (iii) that the accuracy, reliability, or currency of any 
          ...
          <h4>Waiver</h4>
          <p>
            Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms shall not effect 
          ...
          <ul>
            <li>By email: arneseconte@proton.me</li>
          </ul>
        </CardContent>
      </Card>
    </div>
